    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(blank=True, max_length=2, verbose_name='Company country')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Company is active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=255, verbose_name='Office location')),
                ('phone', models.CharField(max_length=15, verbose_name='Phone number')),
                ('email', models.EmailField(max_length=120, unique=True, verbose_name='Email address')),
                ('is_active', models.BooleanField(default=True, verbose_name='Office is active')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('office_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Company', verbose_name='Office company')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
            fields=[
                ...
                ('position', models.CharField(choices=[('JR', 'Junior'), ('MD', 'Middle'), ('SR', 'Senior')], max_length=2)),
                ('skill', models.CharField(max_length=120, verbose_name='Skill')),
                ('language', models.ManyToManyField(to='api.Language')),
                ('work_place', models.ManyToManyField(related_name='worker', to='api.Office')),
            ],
        ),
    ]
